...
export class News extends Component {
    constructor(){
        ...
        this.state = {
            articles: [],
            loading: false,
            page: 1,      // 1-based indexing is usually easier to manage
            pageSize: 9
        }
    }
    ...
    async componentDidMount(){
        ...
        let url = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=72d9cd74446d48cdbd93e8acee117736";
